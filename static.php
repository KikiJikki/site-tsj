...
$query=mysqli_query($mysqli,"select hvs,gvs,dn_el,nc_el,month,year,id from ".$db_table_data." where login=$login1 ORDER BY id DESC");
...
if ($query1 ==false ) {
$pole5 = $pole6 = $pole7 = $pole8 = "Нет предыдущего периода";
}
else {
